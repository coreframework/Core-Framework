...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
   <%:Html.Translate("Permissions", "WebContent.Views.Category")%>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="PageTitleContent" runat="server">
    <h1><%:Html.Translate("Permissions", "WebContent.Views.Category")%></h1>
            ...
            <table class="e_table">
                <tbody>
                    <tr>
                        <th>
                            <span></span>
                            <%:Html.Translate("Role", "WebContent.Views.Category")%>
                        </th>
