...
namespace Core.WebContent.Controllers {
    public partial class WebContentDetailsWidgetController {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public WebContentDetailsWidgetController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected WebContentDetailsWidgetController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public WebContentDetailsWidgetController Actions { get { return WebContentMVC.WebContentDetailsWidget; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly String  Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly String  Name = "WebContentDetailsWidget";
        ...
        public class ViewNames {
            public readonly String  EditWidget = "~/Views/WebContentDetailsWidget/EditWidget.ascx";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_WebContentDetailsWidgetController: Core.WebContent.Controllers.WebContentDetailsWidgetController {
        public T4MVC_WebContentDetailsWidgetController() : base(Dummy.Instance) { }
        ...
        public override System.Web.Mvc.ActionResult UpdateWidget(Core.WebContent.Models.DetailsWidgetEditModel model) {
