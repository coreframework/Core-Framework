...
namespace Products
{
    ...
    public class ModuleAreaRegistration : AreaRegistration
    {
        ...
        {
            //product
            context.MapRoute("Admin.Product", "admin/products", new { controller = "Product", action = "ShowAll", id = "" } , new { httpVerbs = new HttpVerbConstraint(HttpVerbs.Get) });
            context.MapRoute("Admin.Product.DynamicGridData", "admin/products/DynamicGridData", new { controller = "Product", action = "DynamicGridData", id = "" });
            context.MapRoute("Admin.ViewProduct", "admin/products/view-{id}", new { controller = "Product", action = "ShowById", id = "" });
            ...
            //category
            context.MapRoute("Admin.Category", "admin/categories", new { controller = "Category", action = "ShowAll", id = "" }, new { httpVerbs = new HttpVerbConstraint(HttpVerbs.Get) });
            context.MapRoute("Admin.Category.DynamicGridData", "admin/categories/DynamicGridData", new { controller = "Category", action = "DynamicGridData", id = "" });
            context.MapRoute("Admin.ViewCategory", "admin/categories/view-{id}", new { controller = "Category", action = "ShowById", id = "" });
            context.MapRoute("Admin.EditCategory", "admin/categories/edit-{id}", new { controller = "Category", action = "Edit", id = "" });
            context.MapRoute("Admin.NewCategory", "admin/categories/new", new { controller = "Category", action = "New", id = "" });
            context.MapRoute("Admin.RemoveCategory", "admin/categories/remove-{id}", ProductMVC.Category.Remove());
            context.MapRoute("Admin.ChangeCategoryLanguage", "admin/categories/change-language", new { controller = "Category", action = "ChangeLanguage", id = "" }, new { httpVerbs = new HttpVerbConstraint(HttpVerbs.Post) });
