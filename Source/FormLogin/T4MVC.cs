...
public static class FormLoginMVC {
    public static Core.FormLogin.Controllers.LoginWidgetController LoginWidget = new Core.FormLogin.Controllers.T4MVC_LoginWidgetController();
