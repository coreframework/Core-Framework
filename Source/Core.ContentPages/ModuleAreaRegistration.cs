...
namespace Core.ContentPages
{
    ...
    public class ModuleAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute("Admin.ChangeContentPageLanguage", "admin/content-pages/change-language", new { controller = "ContentPage", action = "ChangeLanguage", id = "" }, new { httpVerbs = new HttpVerbConstraint(HttpVerbs.Post) });
