...
namespace Core.ContentPages
{
    ...
    public class ModuleAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute("Admin.ViewContentPage", "admin/content-page/view-{id}", new { controller = "ContentPage", action = "ShowById", id = "" });
            context.MapRoute("Admin.EditContentPage", "admin/content-page/edit-{id}", new { controller = "ContentPage", action = "Edit", id = "" });
            context.MapRoute("Admin.ChangeContentPageLanguage", "admin/content-page/change-language", new { controller = "ContentPage", action = "ChangeLanguage", id = "" }, new { httpVerbs = new HttpVerbConstraint(HttpVerbs.Post) });
            context.MapRoute("Admin.NewContentPage", "admin/content-page/new", new { controller = "ContentPage", action = "New", id = "" });
