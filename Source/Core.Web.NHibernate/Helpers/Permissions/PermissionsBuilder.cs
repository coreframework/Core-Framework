...
namespace Core.Web.NHibernate.Helpers.Permissions
{
    ...
    public class PermissionsBuilder : IPermissionsBuilder
    {
        ...
        private readonly IEntityReferenceService entityReferenceService;
        ...
        /// <param name="entityReferenceService">The entity reference service.</param>
        /// <param name="roleService">The role service.</param>
        /// <param name="permissionService">The permissions service.</param>
        public PermissionsBuilder(Permission rule, IEntityReferenceService entityReferenceService, IRoleService roleService, IPermissionService permissionService)
        {
            this.rule = rule;
        ...
        public PermissionsBuilder(Permission rule, IEntityReferenceService entityReferenceService, IRoleService roleService, IPermissionService permissionService, bool revoke)
        {
            this.rule = rule;
            this.entityReferenceService = entityReferenceService;
            this.roleService = roleService;
        ...
        public IPermissionsBuilder On<T>(T entity)
            where T : IPermissable
        {
            rule.Entity = entityReferenceService.GetEntityReference<T>(entity.EntityId);
            return this;
        }
        ...
        public IPermissionsBuilder On<T>(long entityId)
            where T : IPermissable
        {
            rule.Entity = entityReferenceService.GetEntityReference<T>(entityId);
            return this;
        }
        ...
        {
            rule.Entity = entityReferenceService.GetEntityReference(entityType, entityId);
            return this;
        }
