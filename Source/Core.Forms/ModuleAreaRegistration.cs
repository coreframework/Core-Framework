...
namespace Core.Forms
{
    ...
    public class ModuleAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute("Admin.Forms.DynamicGridData", "admin/forms/DynamicGridData", new { controller = "Forms", action = "DynamicGridData", id = "", area = AreaName });
            ...
            context.MapRoute(null, "admin/form-{formId}/FormElementsDynamicGridData", new { controller = "Forms", action = "FormElementsDynamicGridData", id = "" , area=AreaName });
            ...
            context.MapRoute("Admin.ChangeFormLanguage", "admin/forms/change-language", new { controller = "Forms", action = "ChangeLanguage", id = "" }, new { httpVerbs = new HttpVerbConstraint(HttpVerbs.Post) });
