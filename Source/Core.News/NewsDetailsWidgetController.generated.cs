...
namespace Core.News.Controllers {
    public partial class NewsDetailsWidgetController {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public NewsDetailsWidgetController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected NewsDetailsWidgetController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public NewsDetailsWidgetController Actions { get { return NewsMVC.NewsDetailsWidget; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly String Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly String Name = "NewsDetailsWidget";
        ...
        public class ViewNames {
            public readonly String EditWidget = "~/Views/NewsDetailsWidget/EditWidget.ascx";
            public readonly String ViewWidget = "~/Views/NewsDetailsWidget/ViewWidget.ascx";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_NewsDetailsWidgetController: Core.News.Controllers.NewsDetailsWidgetController {
        public T4MVC_NewsDetailsWidgetController() : base(Dummy.Instance) { }
        ...
        public override System.Web.Mvc.ActionResult UpdateWidget(Core.News.Models.NewsDetailsWidgetEditModel model) {
