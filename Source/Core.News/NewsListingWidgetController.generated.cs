...
namespace Core.News.Controllers {
    public partial class NewsListingWidgetController {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public NewsListingWidgetController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected NewsListingWidgetController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public NewsListingWidgetController Actions { get { return NewsMVC.NewsListingWidget; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly String Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly String Name = "NewsListingWidget";
        ...
        public class ViewNames {
            public readonly String EditWidget = "~/Views/NewsListingWidget/EditWidget.ascx";
            public readonly String ViewWidget = "~/Views/NewsListingWidget/ViewWidget.ascx";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_NewsListingWidgetController: Core.News.Controllers.NewsListingWidgetController {
        public T4MVC_NewsListingWidgetController() : base(Dummy.Instance) { }
        ...
        public override System.Web.Mvc.ActionResult UpdateWidget(Core.News.Models.NewsListingWidgetEditModel model) {
