<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Core.Profiles.Models.LoginWidgetViewModel>" %>
...
<div id="login-form<%=Model.PageWidgetId %>" class="login-widget">
    ...
    <div class="r_info">
        ...
        <span>
            <%: Page.User.Identity.Name %></span> <a href="<%= Url.Action("DeleteUserSession", "LoginWidget", new { area = "Profiles" } ) %>">
