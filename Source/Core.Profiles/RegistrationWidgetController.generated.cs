...
namespace Core.Profiles.Controllers {
    public partial class RegistrationWidgetController {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected RegistrationWidgetController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public RegistrationWidgetController Actions { get { return ProfilesMVC.RegistrationWidget; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly String  Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly String  Name = "RegistrationWidget";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_RegistrationWidgetController: Core.Profiles.Controllers.RegistrationWidgetController {
        public T4MVC_RegistrationWidgetController() : base(Dummy.Instance) { }
        ...
        public override System.Web.Mvc.ActionResult UpdateWidget(Core.Profiles.Models.RegistrationWidgetEditModel model) {
