...
{
    public class ProfileWidgetViewModel : IMappedModel<BaseUser, ProfileWidgetViewModel>
    {
        #region Properties
        ...
        /// </value>
        public bool IsSuccessfulProfile { get; set; }
        ...
        public ProfileWidget Widget { get; set; }

        #endregion

        public ProfileWidgetViewModel MapFrom(BaseUser from)
        {
            Email = from.Email;
