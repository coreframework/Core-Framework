...
public static class OpenIDLoginMVC {
    public static Core.OpenIDLogin.Controllers.OpenIDLoginWidgetController OpenIDLoginWidget = new Core.OpenIDLogin.Controllers.T4MVC_OpenIDLoginWidgetController();
