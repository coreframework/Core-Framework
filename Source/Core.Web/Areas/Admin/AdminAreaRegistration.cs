...
namespace Core.Web.Areas.Admin
{
    ...
    public class AdminAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute("Admin.UserGroups.UpdateUsers", "admin/groups/{id}/users", MVC.Admin.UserGroup.UpdateUsers(), new { httpVerbs = new HttpVerbConstraint(HttpVerbs.Put) });
            ...
            context.MapRoute("Admin.Roles.UpdateUsers", "admin/role/{id}/users", MVC.Admin.Role.UpdateUsers(), new { httpVerbs = new HttpVerbConstraint(HttpVerbs.Put) });
            ...
            context.MapRoute("Admin.Roles.UpdateUserGroups", "admin/role/{id}/groups", MVC.Admin.Role.UpdateUserGroups(), new { httpVerbs = new HttpVerbConstraint(HttpVerbs.Put) });
