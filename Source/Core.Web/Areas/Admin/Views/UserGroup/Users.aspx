<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Admin/Views/Shared/Admin.Master" Inherits="System.Web.Mvc.ViewPage<Core.Web.Areas.Admin.Models.UserToUserGroupAssignmentModel>" %>
...
<asp:Content runat="server" ID="Content2" ContentPlaceHolderID="MainContent">
  ...
  <% using (Html.BeginForm(MVC.Admin.UserGroup.UpdateUsers(), FormMethod.Post)) {%>
