<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Core.Web.Areas.Admin.Models.WidgetViewModel>" %>
...
<asp:Content runat="server" ID="Content2" ContentPlaceHolderID="MainContent">
  <% using (Html.BeginForm(MVC.Admin.Widget.Update(), FormMethod.Post)) {%>
    <div class="i_form clrfix">
		...
		<div class="i_buttons clrfix">
			...
			<span><%: Html.ActionLink(Html.Translate(".Cancel"), MVC.Admin.Widget.Index())%></span>
		</div>
    </div>
  <% } %>
</asp:Content>