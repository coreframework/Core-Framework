...
<asp:Content runat="server" ID="Content2" ContentPlaceHolderID="MainContent">
    ...
    <script type="text/javascript">
        $(function () {
            $('#Save').click(function () {
                $.post('<%= Url.Content(Request.RawUrl + "/UpdateRoles/") %>' + '?' + decodeURIComponent($.param({ ids: $('#list').getDataIDs() }, true)) + '&' + decodeURIComponent($.param({ selids: $('#list').getGridParam('selarrrow') }, true)),
