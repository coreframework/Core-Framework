...
namespace Core.Web.Areas.Navigation.Controllers {
    public partial class NavigationMenuController {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected NavigationMenuController(Dummy d) { }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_NavigationMenuController: Core.Web.Areas.Navigation.Controllers.NavigationMenuController {
        public T4MVC_NavigationMenuController() : base(Dummy.Instance) { }
        ...
        public override System.Web.Mvc.ActionResult UpdateWidget(Core.Web.Areas.Navigation.Models.NavigationMenuWidgetModel model) {
