...
namespace Core.Web.Areas.Navigation.Controllers {
    public partial class ListMenuController {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ListMenuController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ListMenuController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ListMenuController Actions { get { return MVC.Navigation.ListMenu; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly String Area = "Navigation";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly String Name = "ListMenu";
        ...
        public class ViewNames {
            public readonly String EditWidget = "~/Areas/Navigation/Views/ListMenu/EditWidget.ascx";
            public readonly String ListMenuPageItem = "~/Areas/Navigation/Views/ListMenu/ListMenuPageItem.ascx";
            public readonly String ViewWidget = "~/Areas/Navigation/Views/ListMenu/ViewWidget.ascx";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_ListMenuController: Core.Web.Areas.Navigation.Controllers.ListMenuController {
        public T4MVC_ListMenuController() : base(Dummy.Instance) { }
