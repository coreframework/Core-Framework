...
<div id="lookAndFeelForm">
    ...
    <div class="form_area">
        ...
        <fieldset>
            ...
            <label>
                Width</label>
            <%:Html.TextBoxFor(model => model.WidthValue, new { Class = "text-282 text ui-widget-content ui-corner-all", Attr = "width" })%>
            <%:Html.DropDownListFor(model => model.WidthUnit, new SelectList(new List<String> { "px", "em", "pt", "%" }), "Please select", new { Class = " text ui-widget-content ui-corner-all", Attr = "width", style = "margin-left:5px;" })%>
            <label>
                Height</label>
            <%:Html.TextBoxFor(model => model.HeightValue, new { Class = "text-282 text ui-widget-content ui-corner-all", Attr = "height" })%>
            <%:Html.DropDownListFor(model => model.HeightUnit, new SelectList(new List<String> { "px", "em", "pt", "%" }), "Please select", new { Class = " text ui-widget-content ui-corner-all", Attr = "height", style = "margin-left:5px;" })%>
            <label>
                Other</label>
