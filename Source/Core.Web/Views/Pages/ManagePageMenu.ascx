                 ...
                 <%if (Model.Access[(int)PageOperations.Update]) {%>
                    ...
                    <li>
                        ...
                        <ul>
                            <%if (Model.Access[(int)PageOperations.Update]) {%>
                                <li>
                                      <a class="change-settings" href="javascript:void(0);"><%=Html.Translate(".PageSettings")%></a>
                                </li>
                                <li>
                                      <a class="change-layout" href="javascript:void(0);"><%=Html.Translate(".PageLayout")%></a>
                                </li>
                                <li>
                                      <a class="change-lookAndFeel" href="javascript:void(0);"><%=Html.Translate(".PageLookAndFeel")%></a>
                                </li>
                                <li>
                            ...
                            <% }%>
                             <%if (Model.Access[(int)PageOperations.Permissions]) {%>
                                 <li>
                                      <a class="permissions" href="javascript:void(0);"><%=Html.Translate(".Permissions")%></a>
                                </li>
                                <script type="text/javascript">
                                    jQuery(function () {
